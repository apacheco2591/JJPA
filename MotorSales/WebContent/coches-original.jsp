...
<body>
	...
	<!-- Formulario de login o visualización del nombre de usuario y opciones propias -->
	<c:choose>
		<c:when test="${empty sessionScope.usuario}">
			...
			<form action="login" method="post">
				...
				<input type="hidden" name="origen" value="coches" />
		...
		<c:otherwise>
			<fieldset>
				...
				<a href="logout?origen=coches">Salir</a>
			</fieldset>
		</c:otherwise>
	</c:choose>
	...
	<br>
		...
		<!-- Tabla con la lista de coches y sus datos -->
	<c:if test="${requestScope.listaVehiculos == null } ">
		<c:out value="Lista vacia!"></c:out>
	</c:if>
	<fieldset>
		<legend>Anuncios de coches</legend>
		<table>
		<caption>Lista Coches</caption>
			<thead>
				<tr>
					<th>Imagen</th>
					<th>Marca</th>
