...
<link rel="stylesheet" type="text/css" media="screen" href="./style/modificar_tarifa.css">
	...
	<div id='content'>
			...
			<div id='principal'>
				...
				<div id='tabla'>
					...
					<div id='fila'>
						<div id='boton'>
							<b>Modificar Tarifa</b>
						</div>	
					</div>
	
					<form action="modificar_tarifa" method="post" name="formulario" id="formulario">
							...
							<div id='colD'>
								<select name="minMeses" id="minMeses">
									<c:forEach var="i" begin="1" end="12">
										<option value="${i }" <c:if test="${requestScope.tarifa.minMeses == i }"><c:out value='selected="selected"'></c:out></c:if> ><c:out value="${i } meses"></c:out></option>
									</c:forEach>
								</select>
							</div>	
						</div>
						...
						<div id='fila'>
							...
							<div id='colD'>
								<input type="text" name="precio" id ="precio" value='<c:out value="${requestScope.tarifa.precio }"></c:out>' />		
							</div>	
						</div>

						<div id='fila'>
							<div id='boton'>
								<input type="hidden" value="${requestScope.tarifa.id }">
